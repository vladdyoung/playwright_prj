...
class LoginPage(BasePage):
    ...
    def reg_new_user(self):
        ...
        self.page.locator(self.REG_PASS_FIELD).fill(self.session.auth_data['PASSWORD'])
        self.page.locator(self.REPEAT_REG_PASS_FIELD).fill(self.session.auth_data['PASSWORD'])
    ...
    def del_account(self):
        ...
        self.page.locator(self.DEL_PASS_FIELD).fill(self.session.auth_data['PASSWORD'])
